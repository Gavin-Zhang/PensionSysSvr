...
func GetClientHandler(w http.ResponseWriter, r *http.Request) {
	...
	ret, err := gonet.CallByName("HccMysqlSvr", "GetClient", r.FormValue("idx"))
	if err != nil {
		seelog.Error("GetClientHandler call HccMysqlSvr function GetClient err:", err)
...
func GetClientsHandler(w http.ResponseWriter, r *http.Request) {
	...
	ret, err := gonet.CallByName("HccMysqlSvr", "GetClients", page, limit, condition)
	if err != nil {
		seelog.Error("GetClientsHandler call HccMysqlSvr function GetClients err:", err)
		sendErr(w, constant.ResponseCode_ProgramErr, "内部程序错误")
		return
	}
