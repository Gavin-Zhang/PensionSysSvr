...
func GetConsumptionTypeHandler(w http.ResponseWriter, r *http.Request) {
	cors(&w, r)
	...
	ret, err := gonet.CallByName("HccMysqlSvr", "GetConsumptionTypes")
	if err != nil {
		seelog.Error("GetConsumptionTypesHandler call HccMysqlSvr function GetConsumptionTypes err:", err)
