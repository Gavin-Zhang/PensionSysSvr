...
func GetOrderEvaluationHandler(w http.ResponseWriter, r *http.Request) {
	...
	ret, err := gonet.CallByName("mysqlsvr", "GetOrderEvaluation", r.FormValue("orderidx"))
	if err != nil {
		seelog.Error("GetOrderEvaluationHandler call mysqlsvr function GetOrderEvaluation err:", err)
