...
func GetServiceClassHandle(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()
	base.Cors(&w, r)
	...
	if player == nil {
		...
		seelog.Error("GetServiceClassHandle not find player by cookie")
		return
	}
	...
	if err != nil {
		seelog.Error("GetServiceClassHandle call mysqlsvr function GetServiceClassList err:", err)
	...
	if err != nil {
		seelog.Error("GetServiceClassHandle ExpandResult err:", err)
		sendErr(w, constant.ResponseCode_ProgramErr, "内部程序错误")
		return
	}
